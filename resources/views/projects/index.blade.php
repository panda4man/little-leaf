                    ...
                    <form @submit.prevent="validateCreateProject">
                        <v-card-text>
                            <v-container grid-list-md>
                                ...
                                <v-text-field v-validate="'required'" name="name" :error-messages="errors.collect('name')" label="Project Name" v-model="forms.newProject.name"></v-text-field>
                                <v-layout row wrap>
                                    <v-flex xs12 sm6>
                        ...
                        <v-card-actions>
                            <v-spacer></v-spacer>
                            <v-btn :disabled="http.creatingProject || errors.any() " type="submit" color="success">Create</v-btn>
